...
export class Restauracja {
    ...
    email: string 
    www: string 
    constructor(restauracja: Restauracja){
        this.name = restauracja.name
        this.adres = restauracja.adres
        this.telephone = restauracja.telephone
        this.nip = restauracja.nip
        this.email = restauracja.email
        this.www = restauracja.www
    }
    // private _menu: Danie[] = []
